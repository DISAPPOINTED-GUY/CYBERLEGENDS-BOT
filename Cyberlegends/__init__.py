...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Cyberlegends-log.txt"),
...
LOGGER.info("Starting Cyberlegends...")
...
if ENV:
    ...
    from Cyberlegends.config import Development as Config
...
client = TelegramClient("Cyberlegends", api_id, api_hash)
...
from Cyberlegends.modules.helper_funcs.handlers import CustomCommandHandler  # noqa
