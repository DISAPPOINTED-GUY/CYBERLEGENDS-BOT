...
if is_module_loaded(FILENAME):
    ...
    from Cyberlegends import LOGGER, dispatcher
    from Cyberlegends.modules.helper_funcs.chat_status import user_admin
    from Cyberlegends.modules.sql import log_channel_sql as sql
