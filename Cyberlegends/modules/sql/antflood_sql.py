...
from sqlalchemy import String, Column, BigBigInteger, UnicodeText
...
class FloodControl(BASE):
    ...
    user_id = Column(BigBigInteger)
    count = Column(BigBigInteger, default=DEF_COUNT)
    limit = Column(BigBigInteger, default=DEF_LIMIT)
...
class FloodSettings(BASE):
    ...
    chat_id = Column(String(14), primary_key=True)
    flood_type = Column(BigBigInteger, default=1)
