...
from Cyberlegends.modules.helper_funcs.admin_rights import (
    user_can_changeinfo,
    user_can_pin,
    user_can_promote,
)
...
from Cyberlegends.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from Cyberlegends.modules.helper_funcs.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
...
def demote(update, context):
    ...
    user_id = extract_user(message, args)
    if not user_id:
        message.reply_text("Whom am I supposed to promote🤔😑.... .")
        return ""
