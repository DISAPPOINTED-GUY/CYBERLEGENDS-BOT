...
from Cyberlegends.__main__ import GDPR, STATS, USER_INFO
from Cyberlegends.modules.disable import DisableAbleCommandHandler
from Cyberlegends.modules.global_bans import check_cas
from Cyberlegends.modules.helper_funcs.alternate import send_action, typing_action
from Cyberlegends.modules.helper_funcs.extraction import extract_user
from Cyberlegends.modules.helper_funcs.filters import CustomFilters
from Cyberlegends.modules.sql.afk_sql import is_afk
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not Cyberlegends_tgbot data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](https://github.com/p-rinc-e/Cyberlegends.git).",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
