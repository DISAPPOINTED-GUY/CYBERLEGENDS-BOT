...
import Cyberlegends.modules.helper_funcs.fun_strings as fun
from Cyberlegends import DEV_USERS, LOGGER, SUDO_USERS, SUPPORT_USERS, dispatcher
from Cyberlegends.modules.disable import (
...
*Regex based memes:*
 ...
 ➩ `/decide` can be also used with regex like: `Cyberlegends What? <question>: randomly answer "Yes, No" etc.`

  Some other regex filters are:
  `me too` | `good morning` | `good night`.

  Cyberlegends will reply random strings accordingly when these words are used!
...
DECIDE_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(Cyberlegends)"), decide, friendly="decide"
)
