...
PM_START_TEXT = f"""
`Hi..Welcome` [⚡](https://telegra.ph/file/1c554263e1be0ee469fb5.jpg)
`I'm`  𝐂𝐘𝐁𝐄𝐑𝐋𝐄𝐆𝐄𝐍𝐃
`I'm here to help you manage your groups.. Click Help button to find out more about how to use me to my full potential..`
"""

buttons = [[InlineKeyboardButton(text=" 𝗛𝗘𝗟𝗣 𝗔𝗡𝗗 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 ❓",
                                  callback_data="help_back"),
]]

buttons += [[InlineKeyboardButton(text="♻️ 𝘼𝘿𝘿 𝙈𝙀 𝙏𝙊 𝙔𝙊𝙐𝙍 𝙂𝙍𝙊𝙐𝙋 ♻️",
                                  url="t.me/Cyberlegends_TgBot?startgroup=true"),
]]

buttons += [[InlineKeyboardButton(text="🥶𝙈𝙔 𝙊𝙒𝙉𝙀𝙍🥶",
                                  url="https://t.me/RISHISUP3RYO"),
             InlineKeyboardButton(text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 𝗚𝗥𝗢𝗨𝗣🥵",
                                  url="https://t.me/Cyberlegends_support"),
]]
...
HELP_STRINGS = f"""
`Hi.. I'm` 𝗖𝗬𝗕𝗘𝗥𝗟𝗘𝗚𝗘𝗡𝗗[⚡](https://telegra.ph/file/1c554263e1be0ee469fb5.jpg)
